...
public class CollerDefaireRefaire implements CommandeDefaireRefaire{
	private Commande commande_coller;
	
	private MementoEtatMoteur memento;
	private GestionDefaireRefaire gestionnaire_dr; //Caretaker du memento 2
	
	public CollerDefaireRefaire(Commande c,GestionDefaireRefaire g){
		commande_coller = c;
		gestionnaire_dr = g;
	}
	...
	public Memento getMemento() {
		...
		MoteurImpl moteur = ((Coller) commande_coller).getMoteur();
