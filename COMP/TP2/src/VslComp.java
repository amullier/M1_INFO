...
public class VslComp {
	...
	public static void main(String[] args) {
		...
		//On vérifie la présence d'un fichier en entrée
		if (args.length < 1) {
		...
		try {
			...
			try {
				...
				MIPSCodeGenerator cg = new MIPSCodeGenerator(new PrintStream("nachos/test/"+output_name+".s")); // NOT NEEDED AT THE BEGINNING
